...
public class ActionBarSelectionButton extends View {
    ...
    public ActionBarSelectionButton(Context context, @Nullable CharSequence text, Drawable icon, int backgroundColor, int contentColor, int buttonId) {
        super(context);
