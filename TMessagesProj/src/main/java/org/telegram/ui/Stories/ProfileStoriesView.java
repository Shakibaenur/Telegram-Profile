...
public class ProfileStoriesView extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final ProfileTransitionAvatarImageView avatarImage;
    ...
    public ProfileStoriesView(Context context, int currentAccount, long dialogId, boolean isTopic, @NonNull View avatarContainer, ProfileTransitionAvatarImageView avatarImage, Theme.ResourcesProvider resourcesProvider) {
        super(context);
...
//                float cx = left + r + ix;
    ...
    private void animateBounce() {
        ...
        ValueAnimator.AnimatorUpdateListener updater = animation -> {
            ...
            bounceScale = value;
            avatarImage.setBounceScale(value);
